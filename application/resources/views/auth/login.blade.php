...
<head>
	<title>Sign in | Storagemart Time Clock</title>
	<meta charset="utf-8">
		...
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				<div class="auth-box">
					<div class="content">
						<div class="header">
							<div class="logo align-center"><img src="{{ asset('/assets/images/img/Storagemart logo.png') }}" alt="Workday"></div>
						...
						<form class="form-auth-small ui form" action="{{ route('login') }}" method="POST">
							...
							<button type="submit" class="ui orange button large fluid">{{ __('SIGN IN') }}</button>
						</form>
					</div>
				</div>
			</div>
